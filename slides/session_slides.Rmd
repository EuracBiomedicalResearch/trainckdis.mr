...
- .font150[Retrieving summary-level GWAS data:]
  ...
  - .font130[[Phenoscanner](http://www.phenoscanner.medschl.cam.ac.uk/)] `-> MendelianRandomization`

  - .font130[[IEU GWAS database](https://gwas.mrcieu.ac.uk/)] `-> TwoSampleMR`
...
<br>
  ...
  + font120[40 SNPs associated with both eGFRcr and blood urea nitrogen (BUN) at genome-wide threshold] $\left( p-value < 5\times10^{-8} \right)$ $\rightarrow$ .font120[prioritizing IVs most likely relevant for 
  kidney function]
